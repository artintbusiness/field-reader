      ...
      if (awnKey && awnAppKey && awnMac) {
        try {
          ...
          try {
            ...
            const fc = await fetch(`https://api.open-meteo.com/v1/forecast?latitude=${pos.coords.latitude}&longitude=${pos.coords.longitude}&current=temperature_2m,wind_direction_10m&daily=temperature_2m_min,temperature_2m_max,precipitation_sum&temperature_unit=fahrenheit&timezone=auto&forecast_days=10`);
