              ...
              return (
                <div style={{marginTop:14,borderTop:`1px solid ${C.sep}`,paddingTop:14}}>
                  ...
                  {allPlants.map(p=>{
                    ...
                    return (
                      <div key={p.id} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"6px 0",borderBottom:`1px solid ${C.sep}`,background:isDupe?"#FFF2F2":"transparent"}}>
                        <div>
