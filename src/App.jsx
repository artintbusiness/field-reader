...
const F = { display:"'Georgia','Times New Roman',serif", body:"-apple-system,BlinkMacSystemFont,'Segoe UI','Helvetica Neue',Arial,sans-serif" };
const css = {
    ...
    try {
      const res = await fetch("https://api.anthropic.com/v1/messages",{
        ...
        body:JSON.stringify({
          ...
          max_tokens:400,
          messages:[{role:"user",content:
            "You are a practical outdoor advisor. Give a direct, specific recommendation.
...
" +
            "Give 2-3 sentences: confirm the verdict plainly, explain the most important condition factor, and if verdict is wait or no, say specifically when conditions would be right. Be direct and practical. No em dashes."
          }]
        })
      });
      const d = await res.json();
    ...
    } catch(err) { setAiExplain("Could not load explanation: " + err.message); }
    setAiLoading(false);
  }
          ...
          <div style={{
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:4}}>
              ...
              <div style={{
                ...
                padding:"4px 12px",borderRadius:20,background:verdictColors[evalResult.verdict]+"22",
                fontFamily:F.body,
              }}>
