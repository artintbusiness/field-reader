    ...
    try {
      if (awnKey && awnAppKey && awnMac) {
        try {
          ...
          // ── Fetch 24hr AWN history (288 records @ 5min intervals) ──────────
          // Runs in background — doesn't block the UI or affect loading state.
          // Merges into existing history, deduplicating by timestamp bucket.
          (async () => {
            try {
