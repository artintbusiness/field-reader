...
// ══════════════════════════════════════════════════════════════════════════════
function GardenChat({ weather, history, plants, tempOffset=0, onClose }) {
  ...
  function buildSystemPrompt() {
    ...
    return `You are a knowledgeable garden and plant diagnostician embedded in the Plot app. You have full access to the user's backyard conditions, garden advisor readings, and plant journal history. Be specific, practical, and terse. Reference plant names, journal observations, and advisor readings directly. Ask clarifying questions if needed. No em dashes.
