  ...
  return (
    <div>
      ...
      <div style={{...css.card, borderColor:`${C.accent}33`, marginBottom:10}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom: showGenJournal ? 12 : 0}}>
          <div>
            <div style={{display:"flex",alignItems:"center",gap:4}}>
              <span style={css.label}>General Log</span>
              <InfoButton text="For observations not tied to one specific plant — weather events, general garden notes, what you noticed today. Voice dictation will auto-detect plant mentions and link them."/>
            </div>
            <div style={{fontSize:13,color:C.textMid,fontFamily:F.body,marginTop:-4}}>Log anything — voice, photo, or text</div>
          </div>
        ...
        <div style={css.card}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14}}>
            {[
              ...
              {data:history.slice(-24).map(s=>s.pressure*0.02953), color:C.accent, label:"Pressure",unit:'"'},
